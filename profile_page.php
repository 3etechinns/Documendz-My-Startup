...
<script type="text/javascript" src="https://www.dropbox.com/static/api/2/dropins.js" id="dropboxjs" data-app-key="danpbg8vjs8ts8p"></script>
...
<script type="text/javascript">
   ...
   options = {
    ...
    success: function(files) {
                  ...
                  document.getElementById('drp-file-url').value = files[0].link;
                  document.getElementById('drp-file-size').value = files[0].bytes;
                  document.getElementById('drp-file-name').value = files[0].name;
                  $("#dropbox-send").submit();
                   show_iframe_upload();
    },
...
document.getElementById("dropbox-upload").appendChild(button);
   ...
   $(document).on({           
      ...
      window.location = "http://localhost/local_documendz";
       }
      else{
...
<body>
   ...
   <nav class="navbar navbar-default" role="navigation"
    ...
    <div class="container-fluid" style="width:80%;margin:auto">
      <div class="navbar-header"  style="padding:8px;">
	    ...
	    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar" style="margin:0">
  ...
  <nav class="navbar navbar-default" role="navigation"
   ...
   <div role="search" style="width:30%;float:left;min-width:73px;padding-top:5px">
               <input id="search-input" type="text" class="form-control" placeholder="Search files">
            </div> 
   
     
     
      <ul class="nav navbar-nav navbar-right" style="float:right;text-align:right;list-style-type: none;min-width: 100px;margin-top: 0px;margin-bottom: 0px;">
       <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="padding: 10px 17px;"><?php
      ...
      <div class="input-group" style="margin-bottom:10px; width: 100px;">
         <span class="input-group-btn">
            <span class="btn btn-primary  btn-sm btn-file">
               ...
               <form  id="upload-form" enctype = 'multipart/form-data' action="iframe_upload.php" target="my-iframe" method="post">
...
<form id="dropbox-send" method="POST" action="iframe_upload.php" target="my-iframe">
    <input id="drp-file-url" name="drp-file-url" type="hidden" />
   <input id="drp-file-size" name="drp-file-size" type="hidden" />
   
  <input id="drp-file-name" name="drp-file-name" type="hidden" />
      ...
      <?php
         ...
         while ($row = mysql_fetch_array($uploaded_files_of_signed_in_user)) {
             ...
             <td width='20px' ><i class='glyphicon glyphicon-file' style='color:#393c3f'></i></td>
                    <td width='350px' ><a class='file_name self_view' style='color:#393c3f;' name='file_name' href='uploaded/jhg76" . $_SESSION['userid'] . "kd84/" . $row['unique_filename'] . ".html?file=" . htmlentities($row['file_name']) . "&key=0'>" . $row['file_name'] . "</a></td>" . "<td width='130px' style='text-align:right;'><a><i class='glyphicon glyphicon-remove delete_file'></i><a></td>" . "</tr></table>
   ...
   <div id="demo_uploaded_container" class="bs-docs-example">
      ...
      <div class="tab-content">
               ...
               <table width="500px" table-layout="fixed" style="margin-bottom:2px;">
                  <tbody>
                     <tr>
                        ...
                        <td width="130px" style="text-align:right;"><a href="#"><i class="glyphicon glyphicon-remove delete_file"></i></a></td>
                     </tr>
                  </tbody>
               </table>
               <table width="500px" table-layout="fixed" style="margin-bottom:2px;">
            ...
            <div class="individual_file_container" >
               <table width="500px" table-layout="fixed" style="margin-bottom:2px;">
                  <tbody>
                     <tr>
                        <td width="20px"><i class="glyphicon glyphicon-file" style="color:#393c3f"></i></td>
                        <td width="350px"><a class="file_name cboxElement" style="color:#393c3f;" name="file_name" href="#">Company Brochure.pdf</a></td>
                        <td width="130px" style="text-align:right;"><a><i class="glyphicon glyphicon-remove delete_file"></i></a><a></a></td>
                     </tr>
                  </tbody>
               </table>
               <table width="500px" table-layout="fixed" style="margin-bottom:2px;">
                              ...
                              <ul data-step="4" data-intro="dsvfds" class="share_summary_container dropdown-menu" style=" display: block;left: 104%;width: 400px;top: -140%">
                                 ...
                                 <li class="ssc-content" style="background-color:white">
                                    <table cellpadding="0" cellspacing="0" style="table-layout:fixed; width:400px">
                                       <tbody>
                                          <tr>
                                             <td style="width: 40%;overflow:hidden;text-align:left;">Michelle</td>
                                             <td style="width: 15%;text-align: center;">Edit</td>
         ...
         <div id="demo_received" class="tab-pane fade in">
         </div>
      </div>
   </div>
