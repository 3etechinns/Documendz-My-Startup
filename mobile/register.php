 <?php 
  ...
  $password = md5($_GET['p']."kubrv653nerf");   // encrypting password
  $name = $_GET['n'];
  $temp = 0;
...
if($temp == 0){  // New user
  ...
  //mysql_query("INSERT INTO signup "."(username, password, emailid) "."VALUES('$name','$password','$email')");  // ensure escaping strings before inserting
  

mysql_query("INSERT INTO signup (username, password, emailid,verified, workgroups, files, collaborators) VALUES('$name','$password','$email',1,3,10,3)");
